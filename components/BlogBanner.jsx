          ...
          >
            {trending.slice(0, 25).map((item) => (
              <SwiperSlide key={item.id}>
                <div className="product-card bg-white cart-type-neon h-full transform overflow-hidden rounded border border-border-200 bg-light shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow">
