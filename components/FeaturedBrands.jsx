  ...
  return (
    <>
      <div className="relative w-full py-2">
        <button
          className={`swiper-button-prev-fb absolute top-[60%] left-2 z-10 rounded-full transform -translate-y-1/2 bg-white text-white px-1 py-1 ${
        ...
        <button
          className={`swiper-button-next-fb absolute top-[60%] right-2 z-10 rounded-full transform -translate-y-1/2 bg-white text-white px-1 py-1 ${
